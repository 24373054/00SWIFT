...
def build_pacs008_ecny(
    *,
    ...
    uetr: str | None = None,
    purpose: str = "DigitalCurrencyTransfer",
) -> str:
...
def build_pacs002_ecny(
    *, uetr: str, tx_status: str, amount_fen: int, currency: str = "CNY", reason: str | None = None
) -> str:
...
def build_ecny_issuance_msg(
    *, operator: str, amount_fen: int, currency: str = "CNY", action: str = "mint"
) -> str:
...
def build_ecny_cross_border_msg(
    *,
    uetr: str,
    channel: str,
    from_currency: str,
